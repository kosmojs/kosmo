...
description: Best practices for KosmoJS plugins including base configuration organization, explicit environment variables, consistent formatters, and incremental generator adoption.
head:
  - - meta
    - name: keywords
