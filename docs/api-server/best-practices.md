...
description: Best practices for organizing KosmoJS API endpoints including handler responsibilities,
    middleware slots, type declarations, validation patterns, and middleware ordering strategies.
head:
  - - meta
    - name: keywords
      content: koa middleware, api organization, endpoint best practices,
        typescript api patterns, middleware ordering, DRY principles, koa context typing
---
